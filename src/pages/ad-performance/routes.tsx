...
import './ad-performance-theme.css'
// @ts-ignore
...
export default function AdPerformanceRoutes() {
  return (
    <AuthProvider>
      <PermissionsProvider>
        <div className="ad-performance-app" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
          <Routes>
