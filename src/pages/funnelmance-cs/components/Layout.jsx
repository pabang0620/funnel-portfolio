...
function Layout({ children, title }) {
  ...
  const handleLogout = () => {
    logout()
    navigate('/funnelmance-cs')
  }

  const isActive = (path) => location.pathname === path || location.pathname === `/funnelmance-cs${path}`
      ...
      <aside style={{
        ...
        <nav style={{ flex: 1 }}>
          <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
            ...
            <li style={{ marginBottom: '0.25rem' }}>
              <Link
                to="/funnelmance-cs/files"
                onClick={(e) => {
                  e.preventDefault()
                  navigate('/funnelmance-cs/files')
                }}
            ...
            <li style={{ marginBottom: '0.25rem' }}>
              <Link
                to="/funnelmance-cs/users"
                onClick={(e) => {
                  e.preventDefault()
                  navigate('/funnelmance-cs/users')
                }}
