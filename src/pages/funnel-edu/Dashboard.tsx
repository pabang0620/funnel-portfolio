        ...
        <svg viewBox={`0 0 ${svgW || 100} ${H}`} style={{ width: svgW || '100%', height: H, display: 'block' }}>
          ...
          {data.map((d, i) => (
            <text
              ...
              onClick={() => d.id && d.curriculum_id && navigate(`/funnel-edu/curriculums/${d.curriculum_id}/lectures/${d.id}`)}
            >
              {d.week}
            </text>
          ))}
                ...
                {events.map((ev: any, i: number) => {
                  ...
                  return (
                    <div
                      ...
                      onClick={() => navigate(`/funnel-edu/curriculums/${ev.curriculum_id}/lectures/${ev.id}`)}
                    >
            ...
            {curriculums.map((cur: any) => {
              ...
              return (
                <div
                  ...
                  onDoubleClick={() => navigate(`/funnel-edu/curriculums/${cur.id}`)}
        ...
        <div className="grid grid-cols-3 gap-4 items-stretch">
          ...
          <div className="col-span-1 flex">
            <BottomRankingChart
              ...
              onClickStudent={id => navigate(`/funnel-edu/students/${id}`)}
            />
          </div>
        </div>
      )}
