...
import './portfolio-edu-theme.css'
...
export default function PortfolioEduRoutes() {
  return (
    <div className="portfolio-edu-app" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <Routes>
