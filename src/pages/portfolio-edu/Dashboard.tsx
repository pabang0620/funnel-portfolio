        ...
        <svg viewBox={`0 0 ${svgW || 100} ${H}`} style={{ width: svgW || '100%', height: H, display: 'block' }}>
          ...
          {data.map((d, i) => (
            <text
              ...
              onClick={() => d.id && d.curriculum_id && navigate(`/portfolio-edu/curriculums/${d.curriculum_id}/lectures/${d.id}`)}
            >
              {d.week}
            </text>
          ))}
                ...
                {events.map((ev: any, i: number) => {
                  ...
                  return (
                    <div
                      ...
                      onClick={() => navigate(`/portfolio-edu/curriculums/${ev.curriculum_id}/lectures/${ev.id}`)}
                    >
            ...
            {curriculums.map((cur: any) => {
              ...
              return (
                <div
                  ...
                  onDoubleClick={() => navigate(`/portfolio-edu/curriculums/${cur.id}`)}
        ...
        <div className="grid grid-cols-3 gap-4 items-stretch">
          ...
          <div className="col-span-1 flex">
            <BottomRankingChart
              ...
              onClickStudent={id => navigate(`/portfolio-edu/students/${id}`)}
            />
          </div>
        </div>
      )}
