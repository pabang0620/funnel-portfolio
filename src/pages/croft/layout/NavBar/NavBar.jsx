...
import { useChartData } from '../../component/utils/api/Charts/ChartAPI.jsx';
            ...
            <div className="flex-1 flex justify-end items-center space-x-4 text-Secondary">
              ...
              {ImgArray.map((url, idx) => (
                <div className="text-lg font-semibold flex flex-row" key={idx}>
                  <img
                    className="mt-1 mr-2"
                    src={`/croft/assets/images/Layout/${url}.svg`}
                    alt=""
                  />
              ...
              <button className="text-lg font-semibold">
                <img
                  ...
                  src={`/croft/assets/images/Layout/OutIcon.svg`}
                  alt=""
                />
              </button>
            </div>
