...
function Layout({ children, title }) {
  ...
  const handleLogout = () => {
    logout()
    navigate('/portfolio-cs')
  }

  const isActive = (path) => location.pathname === path || location.pathname === `/portfolio-cs${path}`
        ...
        <nav style={{ flex: 1 }}>
          <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
            <li style={{ marginBottom: '0.25rem' }}>
              <Link
                to="/portfolio-cs/upload"
                onClick={(e) => {
                  e.preventDefault()
                  navigate('/portfolio-cs/upload')
                }}
            ...
            <li style={{ marginBottom: '0.25rem' }}>
              <Link
                to="/portfolio-cs/files"
                onClick={(e) => {
                  e.preventDefault()
                  navigate('/portfolio-cs/files')
                }}
            ...
            <li style={{ marginBottom: '0.25rem' }}>
              <Link
                to="/portfolio-cs/users"
                onClick={(e) => {
                  e.preventDefault()
                  navigate('/portfolio-cs/users')
                }}
